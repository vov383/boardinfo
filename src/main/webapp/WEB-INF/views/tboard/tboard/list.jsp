    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnWrite").on("click", function () {
                location.href = "${path}/tboard/write";
            });
            /*카테고리 버튼*/
        ...
        function list(page) {
            ...
            location.href = "${path}/tboard/list?" + queryString;
        }
    </script>
</head>
<body>
                            ...
                            <c:choose>
                                <c:when test="${row.category eq '판매'}">
                                        <span class="category" title="판매">
                                            <a href="${path}/tboard/list?category=판매">판매</a>
                                        </span>
                                </c:when>
                                <c:when test="${row.category eq '구매'}">
                                        <span class="category" title="구매">
                                            <a href="${path}/tboard/list?category=구매">구매</a>
                                        </span>
                                </c:when>
                                <c:when test="${row.category eq '나눔'}">
                                        <span class="category" title="나눔">
                                            <a href="${path}/tboard/list?category=나눔">나눔</a>
                                        </span>
                                </c:when>
                                <c:otherwise>
                                        <span class="category" title="완료">
                                            <a href="${path}/tboard/list?category=완료">완료</a>
                                        </span>
                                </c:otherwise>
                            </c:choose>
