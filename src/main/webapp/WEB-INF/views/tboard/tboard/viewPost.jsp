        ...
        $(function () {
            ...
            */
            ...
            $(".btnChange").on("click", function () {
                ...
                location.href = "${path}/tboard/change/${map.dto.tb_num}";
            });
            /* 로그인버튼 */
                    ...
                    if (re_list != null && re_list.length > 0) {
                        ...
                        for (let i = 0; i < re_list.length; i++) {
                            ...
                            if (delCheck === 'Y') {
                                ...
                                let userNickNameDiv = $("<div>").addClass("userNickName").attr("nickname", re_list[i].nickname).text(re_list[i].nickname);
                                ...
                                let userProfileImg = $("<img>").addClass("userProfile")
                                    .attr("src", "${path}/resources/uploaded_image/" + re_list[i].profile);
        ...
        <div id="contentsMain">
            ...
            <section class="titleSection">
                ...
                <div class="profileAndNickName">
                    <div class="left">
                        <div>
                            <img class="userProfile" src="${path}/resources/uploaded_image/${map.dto.profile}">
                        </div>
                        <div class="dot"></div>
                        <div class="nickName"><a class="userNickName"
                                                 href="${path}/mypage/moveUserPage/${map.dto.create_user}">${map.dto.nickname}(${map.dto.create_user})</a>
                        </div>
                        <div class="dot"></div>
            ...
            <div class="listAndEdit">
                <div class="left">
                    <div class="button"><a href="${path}/tboard/list">목록</a></div>
                </div>
                <div class="dot"></div>
                <div class="right">
                    <c:choose>
                        <c:when test="${sessionScope.userid eq map.dto.create_user}">
                            <div class="button"><a class="btnChange">수정|삭제</a></div>
                        </c:when>
                        <c:when test="${sessionScope.admin_id eq null && sessionScope.userid ne map.dto.create_user}">
                        </c:when>
                    </c:choose>
