        ...
        <div id="contentsMain">
            ...
            <section class="titleSection">
                ...
                <div class="profileAndNickName">
                    <div class="left">
                        <div class="userImg"><a class="userProfile"><img
                                src="${path}/resources/uploaded_image${map.dto.profile}"></a></div>
                        <div class="dot"></div>
                        <div class="nickName"><a class="userNickName">${map.dto.nickname}(${map.dto.create_user})</a>
                        </div>
                        <div class="dot"></div>
